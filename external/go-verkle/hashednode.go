...
func (n HashedNode) Insert([]byte, []byte, NodeResolverFn) error {
	return errInsertIntoHash
}

func (n HashedNode) Delete([]byte, NodeResolverFn) (bool, error) {
	return false, errors.New("cant delete a hashed node in-place")
}

func (n HashedNode) Get([]byte, NodeResolverFn) ([]byte, error) {
...
func (n HashedNode) Copy() VerkleNode {
	return HashedNode{n.commitment}
}
