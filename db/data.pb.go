...
type BaseMessage struct {
	...
	TargetHeight   uint64 `protobuf:"varint,3,opt,name=target_height,json=targetHeight,proto3" json:"target_height,omitempty"`       // 期望执行交易的高度
	ExecutedHeight uint64 `protobuf:"varint,4,opt,name=executed_height,json=executedHeight,proto3" json:"executed_height,omitempty"` // 实际执行的区块高度
...
func (x *BaseMessage) GetTargetHeight() uint64 {
	if x != nil {
...
type Account struct {
	...
	Balances        map[string]*TokenBalance `protobuf:"bytes,5,rep,name=balances,proto3" json:"balances,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // key为token地址
...
type TokenBalance struct {
	...
	MinerLockedBalance     string `protobuf:"bytes,3,opt,name=miner_locked_balance,json=minerLockedBalance,proto3" json:"miner_locked_balance,omitempty"`             // 共识挖矿锁定余额(前100+frost)
...
func (m *AnyTx) GetContent() isAnyTx_Content {
	if m != nil {
		return m.Content
	}
	return nil
...
func (x *AnyTx) GetIssueTokenTx() *IssueTokenTx {
	if x, ok := x.GetContent().(*AnyTx_IssueTokenTx); ok {
...
func (x *AnyTx) GetFreezeTx() *FreezeTx {
	if x, ok := x.GetContent().(*AnyTx_FreezeTx); ok {
		return x.FreezeTx
	}
	return nil
}
...
func (x *AnyTx) GetTransaction() *Transaction {
	if x, ok := x.GetContent().(*AnyTx_Transaction); ok {
...
func (x *AnyTx) GetOrderTx() *OrderTx {
	if x, ok := x.GetContent().(*AnyTx_OrderTx); ok {
		return x.OrderTx
	}
	return nil
}
...
func (x *AnyTx) GetAddressTx() *RechargeTx {
	if x, ok := x.GetContent().(*AnyTx_AddressTx); ok {
		return x.AddressTx
	}
	return nil
}
...
func (x *AnyTx) GetCandidateTx() *CandidateTx {
	if x, ok := x.GetContent().(*AnyTx_CandidateTx); ok {
...
func (x *AnyTx) GetMinerTx() *MinerTx {
	if x, ok := x.GetContent().(*AnyTx_MinerTx); ok {
		return x.MinerTx
	}
	return nil
}
...
type PushQuery struct {
	...
	ContainerIsBlock bool   `protobuf:"varint,3,opt,name=container_is_block,json=containerIsBlock,proto3" json:"container_is_block,omitempty"` // 为true表示是完整数据，false表示只有txs
	Container        []byte `protobuf:"bytes,4,opt,name=container,proto3" json:"container,omitempty"`                                          // 当tx数量小于2500时候，该字段为所有交易的完整二进制数据，>=2500的时候为 所有交易的简短tx_hash
...
type Chits struct {
	...
	PreferredBlock string `protobuf:"bytes,2,opt,name=preferred_block,json=preferredBlock,proto3" json:"preferred_block,omitempty"`
	// ID of the last accepted block
	AcceptedBlock string `protobuf:"bytes,3,opt,name=accepted_block,json=acceptedBlock,proto3" json:"accepted_block,omitempty"`
	// ID of the currently preferred block at the requested height
	PreferredBlockAtHeight string `protobuf:"bytes,4,opt,name=preferred_block_at_height,json=preferredBlockAtHeight,proto3" json:"preferred_block_at_height,omitempty"`
	...
	Bitmap         []byte `protobuf:"bytes,6,opt,name=bitmap,proto3" json:"bitmap,omitempty"` //上一个区块与自己联系过的节点
}
...
func (x *Chits) GetPreferredBlockAtHeight() string {
	if x != nil {
...
var file_db_data_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x8a, 0x02, 0x0a, 0x0b, 0x42, 0x61, 0x73, 0x65, 0x4d, 0x65, 0x73,
	...
	0x0b, 0x66, 0x72, 0x6f, 0x6d, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x23, 0x0a, 0x0d,
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x0c, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x48, 0x65, 0x69, 0x67, 0x68,
	0x74, 0x12, 0x27, 0x0a, 0x0f, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x64, 0x5f, 0x68, 0x65,
	0x69, 0x67, 0x68, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x65, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x65, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x75,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x22, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x74, 0x61,
	...
	0x65, 0x22, 0xe1, 0x03, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x18, 0x0a,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	...
	,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb6, 0x02, 0x0a, 0x0c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42,
	...
	0x12, 0x38, 0x0a, 0x18, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x6c, 0x6f,
	0x63, 0x6b, 0x65, 0x64, 0x5f, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x16, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x6f, 0x63,
	0x6b, 0x65, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x14, 0x6d, 0x69,
	...
	0x65, 0x4c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xc4,
	0x02, 0x0a, 0x05, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x69, 0x67,
	...
	,
	...
	0x28, 0x09, 0x52, 0x09, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a,
	0x0c, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x18, 0x03, 0x20,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x75, 0x70,
	0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x61, 0x6e, 0x4d, 0x69, 0x6e, 0x74, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x63, 0x61, 0x6e, 0x4d, 0x69, 0x6e, 0x74, 0x22, 0x87, 0x01,
	0x0a, 0x08, 0x46, 0x72, 0x65, 0x65, 0x7a, 0x65, 0x54, 0x78, 0x12, 0x23, 0x0a, 0x04, 0x62, 0x61,
	...
	,
	...
	0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xbc, 0x02, 0x0a, 0x07, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x54, 0x78, 0x12, 0x23, 0x0a, 0x04, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x04, 0x62, 0x61, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x61, 0x73,
	...
	0x75, 0x6f, 0x74, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1b, 0x0a, 0x02, 0x6f, 0x70, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x4f, 0x70, 0x52, 0x02, 0x6f, 0x70, 0x12, 0x20, 0x0a, 0x0c, 0x6f, 0x70, 0x5f, 0x74, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6f, 0x70,
	0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75,
	...
	,
	...
	0x70, 0x52, 0x02, 0x6f, 0x70, 0x12, 0x2b, 0x0a, 0x11, 0x63, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	...
	0x28, 0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x63, 0x0a, 0x07, 0x4d, 0x69,
	...
	0xe9, 0x02, 0x0a, 0x05, 0x41, 0x6e, 0x79, 0x54, 0x78, 0x12, 0x38, 0x0a, 0x0e, 0x69, 0x73, 0x73,
	...
	,
	...
	0x65, 0x73, 0x22, 0x5a, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x70,
	0x12, 0x16, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x65, 0x64, 0x12, 0x24, 0x0a, 0x0e, 0x70, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x70, 0x65, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x50, 0x65, 0x6d, 0x22, 0x6c,
	...
	0x09, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x2b, 0x0a, 0x11,
	...
	0x28, 0x09, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x1e, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x13, 0x0a, 0x05, 0x74, 0x78, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x74, 0x78, 0x49, 0x64, 0x22, 0x29, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x42,
	...
	0x67, 0x68, 0x74, 0x22, 0x49, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52,
	...
	0x6b, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f,
	0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x3b,
	0x0a, 0x16, 0x42, 0x61, 0x74, 0x63, 0x68, 0x47, 0x65, 0x74, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x54,
	0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x68, 0x6f, 0x72,
	0x74, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0b,
	0x73, 0x68, 0x6f, 0x72, 0x74, 0x48, 0x61, 0x73, 0x68, 0x65, 0x73, 0x22, 0x48, 0x0a, 0x17, 0x42,
	...
	0x65, 0x73, 0x74, 0x22, 0xd3, 0x01, 0x0a, 0x09, 0x50, 0x75, 0x73, 0x68, 0x51, 0x75, 0x65, 0x72,
	...
	0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x64,
	0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x2c, 0x0a, 0x12, 0x63, 0x6f, 0x6e, 0x74, 0x61,
	0x69, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x73, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x10, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x73,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	...
	,
	...
	0x5f, 0x61, 0x74, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	...
	0x70, 0x74, 0x65, 0x64, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x0e, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x48, 0x65, 0x69, 0x67, 0x68,
	0x74, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x69, 0x74, 0x6d, 0x61, 0x70, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x06, 0x62, 0x69, 0x74, 0x6d, 0x61, 0x70, 0x2a, 0x1e, 0x0a, 0x07, 0x4f, 0x72, 0x64,
	...
	0x53, 0x55, 0x43, 0x43, 0x45, 0x45, 0x44, 0x10, 0x02, 0x42, 0x17, 0x5a, 0x15, 0x61, 0x77, 0x65,
	0x73, 0x6f, 0x6d, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x31, 0x2f, 0x64, 0x62, 0x3b,
...
var file_db_data_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_db_data_proto_goTypes = []any{
	...
	nil,                              // 36: pb.TokenRegistry.TokensEntry
	nil,                              // 37: pb.Account.BalancesEntry
}
var file_db_data_proto_depIdxs = []int32{
	36, // 0: pb.TokenRegistry.tokens:type_name -> pb.TokenRegistry.TokensEntry
	1,  // 1: pb.BaseMessage.status:type_name -> pb.Status
	37, // 2: pb.Account.balances:type_name -> pb.Account.BalancesEntry
